...
print('STARTING EVALUATION WITH ITEMKNN')

experiment_datetime = '2020-11-19 18:08:59.240914'

for fold_n in trange(5, desc='folds'):

    log_val_str = UN_LOG_VAL_STR.format('itemknn', experiment_datetime, os.path.basename(DATA_PATH), fold_n)
    log_te_str = UN_LOG_TE_STR.format('itemknn', experiment_datetime, os.path.basename(DATA_PATH), fold_n)
