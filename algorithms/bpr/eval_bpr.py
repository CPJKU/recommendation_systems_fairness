...
best_configs = {
    'standard': '2020-11-25 10:49:36.093992',
    'up_sample': '2020-11-25 16:49:36.665291',
    'down_sample': '2020-11-25 10:49:14.161742'
}
...
if __name__ == '__main__':
    ...
    print('STARTING EVALUATION <{}> WITH BPR'.format(experiment_type))
    ...
    for fold_n in trange(5, desc='folds'):
        ...
        log_val_str = LOG_VAL_STR.format('bpr', experiment_type, experiment_datetime, fold_n)
        log_te_str = LOG_TE_STR.format('bpr', experiment_type, experiment_datetime, fold_n)
