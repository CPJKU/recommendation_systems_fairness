...
if __name__ == '__main__':
    ...
    print('STARTING EVALUATION <{}> WITH ALS'.format(experiment_type))
    ...
    for fold_n in trange(5, desc='folds'):
        ...
        log_val_str = LOG_VAL_STR.format('als', experiment_type, experiment_datetime, fold_n)
        log_te_str = LOG_TE_STR.format('als', experiment_type, experiment_datetime, fold_n)
