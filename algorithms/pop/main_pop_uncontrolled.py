...
from utils.eval import eval_metric, eval_proced2_beyond_accuracy
...
if __name__ == '__main__':
    ...
    print('STARTING EXPERIMENTS <{}> WITH POP'.format(experiment_type))
    ...
    for fold_n in trange(5, desc='folds'):
        ...
        log_val_str = LOG_VAL_STR.format('pop', experiment_type, now, fold_n)
        log_te_str = LOG_TE_STR.format('pop', experiment_type, now, fold_n)
