...
print('STARTING EVALUATION WITH EASE')

experiment_datetime = '2020-11-19 16:32:40.811648'

for fold_n in trange(5, desc='folds'):

    log_val_str = UN_LOG_VAL_STR.format('ease', experiment_datetime, os.path.basename(DATA_PATH), fold_n)
    log_te_str = UN_LOG_TE_STR.format('ease', experiment_datetime, os.path.basename(DATA_PATH), fold_n)
